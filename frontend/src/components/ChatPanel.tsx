...
export default function ChatPanel({
  ...
  return (
    <div
      ...
      style={{ padding: '20px', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', minHeight: '68vh' }}
    >
      <div
        style={{
      ...
      >
        <div>
          ...
          <h3 style={{ fontSize: '15px', fontWeight: 700, color: '#f3f4f6', margin: '4px 0 0 0' }}>
            Chat with Codebase
          </h3>
        </div>
        ...
        {chatHistory.length === 0 ? (
          ...
          >
            ...
            <div style={{ maxWidth: '400px' }}>
              <span
                style={{ fontSize: '13px', fontWeight: 700, color: '#f3f4f6', display: 'block', marginBottom: '4px' }}
              >
            ...
            >
              {[
                ...
                <button
                  key={qIdx}
                  onClick={() => setChatInput(queryText)}
                  style={{
              ...
              {msg.role === 'assistant' && msg.sources && msg.sources.length > 0 && (
                ...
                >
                  {msg.sources.map((source, sIdx) => (
                    ...
                    >
                      <FileCode size={10} />
                      {source.source || source.file || 'unknown'}
                      {(source.line ?? 0) > 0 ? `:${source.line}` : ''}
                    </span>
                  ))}
                </div>
              )}
